    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cb != 0)
                {
                    DialogResult result = MessageBox.Show("It seems that you have entered a non-zero CB, this means you are potientally blocking certain exploits depending on this value.\nIs this okay?", "NON-ZERO CB", MessageBoxButtons.YesNo);
            ...
            if (chkAuto.Checked)
            {
                switch (motherboard)
                {
                    ...
                    case "Xenon":
                        switch (hacktype)
                        {
                            case "JTAG": patchesFileName = "patches_xenon.bin"; fusesPatchOffset = 0x538;
                                break;
                            case "Glitch":
